    ...
    <div className="Calculator">
      <div className="Calcontainer">
        ...
        <div className="Buttons">
          ...
          <Key className="MAGCALAS" label="Name" clickHandler={nameClickHandler} />
          <Key className="MAGCALAS" label="Subj" clickHandler={subjectClickHandler} />
          <Key className="MAGCALAS" label="Pin" clickHandler={pinClickHandler} />
        </div>
      </div>
    </div>
  );
